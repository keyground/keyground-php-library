...
$video = $kg->getVideo($_GET['videoId']);
$channel = $kg->getChannel('id', $video->channelId);
...
<body>
	...
	<div class="main_container">
		<div class="main">
			...
			<div class="player"><?=$video->embedCode?></div>
			<div class="description"><?=$video->description?></div>
			<div class="line1"></div>
			<h1>Recent Videos of <?=$channel->name?></h1>
			<div class="line1"></div>
			...
			<?foreach($videoList as $video){ ?>
				<div class="video_row">
					<div class="video_thumb_img">
						<a href="video.php?videoId=<?=$video->id?>"> <img width="180" height="100" src="<?=$video->getThumb()?>"> </a>
					</div>
